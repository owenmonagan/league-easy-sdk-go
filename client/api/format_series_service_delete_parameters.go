...
// WithTournamentID adds the tournamentID to the format series service delete params
func (o *FormatSeriesServiceDeleteParams) WithTournamentID(tournamentID *string) *FormatSeriesServiceDeleteParams {
	o.SetTournamentID(tournamentID)
	return o
}

// SetTournamentID adds the tournamentId to the format series service delete params
func (o *FormatSeriesServiceDeleteParams) SetTournamentID(tournamentID *string) {
