...
// WithTournamentID adds the tournamentID to the stage round robin service view params
func (o *StageRoundRobinServiceViewParams) WithTournamentID(tournamentID *string) *StageRoundRobinServiceViewParams {
	o.SetTournamentID(tournamentID)
	return o
}

// SetTournamentID adds the tournamentId to the stage round robin service view params
func (o *StageRoundRobinServiceViewParams) SetTournamentID(tournamentID *string) {
