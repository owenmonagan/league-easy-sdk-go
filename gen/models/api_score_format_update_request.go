...
// APIScoreFormatUpdateRequest api score format update request
//
// swagger:model apiScoreFormatUpdateRequest
type APIScoreFormatUpdateRequest struct {
	...
	// has format
	HasFormat []*APIScoreFormatUpdateRequestHasFormat `json:"hasFormat"`
...
// Validate validates this api score format update request
func (m *APIScoreFormatUpdateRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APIScoreFormatUpdateRequest) validateFields(formats strfmt.Registry) error {
...
func (m *APIScoreFormatUpdateRequest) validateHasFormat(formats strfmt.Registry) error {
...
func (m *APIScoreFormatUpdateRequest) validatePointsPerPosition(formats strfmt.Registry) error {
...
func (m *APIScoreFormatUpdateRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *APIScoreFormatUpdateRequest) UnmarshalBinary(b []byte) error {
	var res APIScoreFormatUpdateRequest
