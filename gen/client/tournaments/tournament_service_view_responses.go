...
func (o *TournamentServiceViewOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/tournaments/{uuid}][%d] tournamentServiceViewOK  %+v", 200, o.Payload)
}

func (o *TournamentServiceViewOK) GetPayload() *models.APITournament {
	return o.Payload
}
...
func (o *TournamentServiceViewDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/tournaments/{uuid}][%d] TournamentService_View default  %+v", o._statusCode, o.Payload)
}

func (o *TournamentServiceViewDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
